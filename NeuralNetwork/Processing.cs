namespace NeuralNetwork
{
    ...
    public partial class Processing
    {
        ...
        static CudaAccelerator _accelerator;
        ...
        static Processing()
        {
            ...
            _kernel_ConvolveVolumeWithFilter_Backward = _accelerator.LoadAutoGroupedStreamKernel<Index1D, ArrayView<double>, int, int, int, ArrayView<double>, int, int, int, double, ArrayView<double>, ArrayView<double>>(Kernel_ConvolveVolumeWithFilter_Backward);
